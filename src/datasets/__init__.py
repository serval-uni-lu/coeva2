from src.datasets.botnet_dataset import BotnetDataset, BotnetAugmentedDataset, BotnetRfAugmentedDataset
...
datasets = {
    ...
    "botnet_rf": BotnetDataset,
    "botnet_rf_augmented": BotnetRfAugmentedDataset,
