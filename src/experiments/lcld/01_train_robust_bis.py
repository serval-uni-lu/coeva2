...
from src.experiments.lcld.model_bis import train_model, print_score
...
scaler_path = f"./models/{project_name}/scaler_bis.joblib"
...
model_path = f"./models/{project_name}/nn_bis.model"
...
important_features_path = f"./data/{project_name}/important_features_bis.npy"
...
# ----- AUGMENT DATASET
x_train_augmented_path = f"./data/{project_name}/x_train_augmented_bis.npy"
x_test_augmented_path = f"./data/{project_name}/x_test_augmented_bis.npy"
features_augmented_path = f"./data/{project_name}/features_augmented_bis.csv"
constraints_augmented_path = f"./data/{project_name}/constraints_augmented_bis.csv"
...
scaler_augmented_path = f"./models/{project_name}/scaler_augmented_bis.joblib"
...
model_augmented_path = f"./models/{project_name}/nn_augmented_bis.model"
...
if os.path.exists(x_train_moeva_path):
    ...
    x_train_candidates = x_train_candidates[batch_i*nb_per_batch : (batch_i+1)*nb_per_batch]
...
x_train_adv_gradient_path = f"./data/{project_name}/x_train_adv_gradient_bis.npy"
...
model_adv_gradient_path = f"./models/{project_name}/nn_gradient_bis.model"
